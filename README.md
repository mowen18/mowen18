...
* [Running Analytics](https://github.com/mowen18/running-analytics-pipeline): Data analytics pipeline evaluating whether aerobic running efficiency is improving over time. Strava + Open-Meteo → Python → Postgres → dbt → Streamlit. Incremental & idempotent.
...
* [Divvy Analytics](https://github.com/mowen18/divvy-analytics): Idempotent incremental analytics pipeline using Python ingestion, PostgreSQL, dbt, and Airflow.
